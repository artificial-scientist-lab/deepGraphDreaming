...
parameter_list = [[10000000, 1*10**-3, '.pt','_4PartGHZ',desired_state_2, [2]*4, 0.00001,False,1,True], [10000000, 1*10**-3, 'ZERO.pt','_4PartGHZ',desired_state_2, [2]*4, 0.00001,True,1,True]]
...
isZero = parameter_list[shift-1][9] # Sets the fidelities in the training set to zero if true. Useful if we want to set a baseline for 
...
input_edges, ket_amplitudes, output_fidelity = generatorGraphFidelity(DIM, desired_state,  num_edges=None ,short_output=False)
...
print(os.getcwd() + f'/GraphDreamForward2_{num_of_examples}' + nn_case + end_of_string)
 ...
 #train the model 
train_model(NN_INPUT,NN_OUTPUT,vals_train_np,res_train_np, vals_test_np, res_test_np, learnRate, direc, nn_case, num_of_examples,nnType,l2Lambda,isL2Reg)
